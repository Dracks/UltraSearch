...
import es.jaumesingla.ultrasearchfree.Constants.ListServiceUpdate;
...
public class UltraSearchApp extends Application {
	...
	private static final String oldPreferenceName = "QuickSearchData";
	...
	private void createConfiguration() {
		SharedPreferences oldSettings=getSharedPreferences(oldPreferenceName, 0);
		
		long timeBloquedAds=oldSettings.getLong(Free.TIME_BLOQUED_ADS_KEY, 0);
		...
		config.putLong(Free.TIME_BLOQUED_ADS_KEY, timeBloquedAds);
